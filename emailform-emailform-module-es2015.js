...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmailformPage", function() { return EmailformPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_emailform_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./emailform.page.html */ "JsuJ");
/* harmony import */ var _emailform_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./emailform.page.scss */ "s+WF");
...
let EmailformPage = class EmailformPage {
    constructor(user, router, modalCtrl, _location) {
        this.user = user;
        this.router = router;
    ...
    btnclick(email, emaill) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            var k = this.validateEmail(email);
            if (email == null) {
                ...
                this.user.emailForm(email, this.t, this.detail).subscribe((res) => {
                    ...
                    if (res.m == "Failed to deliver the mail, Hemce the account not created. This may due to invalid email. Kindly provide a Valid email") {
                        this.user.toast("Failed to deliver the mail, Hemce the account not created. This may due to invalid email. Kindly provide a Valid email", 'bottom', 2000, 'normalToast');
                        this.router.navigateByUrl('/emailform');
                    }
                    if (res.m == "Account already activated") {
                        this.user.toast("This account is already activated", 'bottom', 2000, 'noramlToast');
                        this.router.navigateByUrl("/partydetails");
                    }
                    if (res.m == "Account created") {
                        ...
                        if (localStorage.getItem('p') == 'lokc') {
                            ...
                            this.router.navigateByUrl('/partycandidates');
                        }
                        else if (localStorage.getItem('p') == 'ac') {
                            this.router.navigateByUrl('/statepartylok');
                        }
                        else if (localStorage.getItem('p') == 'cc') {
                            this.router.navigateByUrl('/council');
                        }
...
EmailformPage.ctorParameters = () => [
    { type: _home_service__WEBPACK_IMPORTED_MODULE_4__["HomeService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ModalController"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_7__["Location"] }
];
EmailformPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmailformPageRoutingModule", function() { return EmailformPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _emailform_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emailform.page */ "8gHb");
...
let EmailformPageRoutingModule = class EmailformPageRoutingModule {
};
EmailformPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmailformPageModule", function() { return EmailformPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
/* harmony import */ var _emailform_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./emailform-routing.module */ "CBf1");
/* harmony import */ var _emailform_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./emailform.page */ "8gHb");
...
let EmailformPageModule = class EmailformPageModule {
};
EmailformPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _emailform_routing_module__WEBPACK_IMPORTED_MODULE_5__["EmailformPageRoutingModule"]
        ],
...
//# sourceMappingURL=emailform-emailform-module-es2015.js.map