...
let LoginPage = class LoginPage {
    constructor(user, navCtrl, router) {
        this.user = user;
    ...
    save(user1) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!user1.username || user1.username == '') {
                ...
                let obj = this;
                obj.user.signin(obj.user1).subscribe((res) => {
                    if (res.token) {
                        ...
                        if (res.mn == 'mn') {
                            ...
                            obj.user.rajparty().subscribe(resp => {
                            ...
                            this.router.navigateByUrl('/rajyasabhaindividual');
                        }
                    ...
                    this.user.toast("Invalid credentials or Network connection issue ", 'bottom', 3000, 'normalToast');
                });
            }
        });
    }
