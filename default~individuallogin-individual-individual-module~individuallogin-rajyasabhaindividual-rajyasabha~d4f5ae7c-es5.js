(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~individuallogin-individual-individual-module~individuallogin-rajyasabhaindividual-rajyasabha~d4f5ae7c"], {
    ...
    /***/
    function MuSt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "IndividualPage", function () {
      ...
      var _raw_loader_individual_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./individual.page.html */
      "v5aH");
      /* harmony import */


      var _individual_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./individual.page.scss */
      "TdKw");
      /* harmony import */
      ...
      var _data_k__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../data/k */
      "Ew1Z");

      var IndividualPage = /*#__PURE__*/function () {
        function IndividualPage(http, user, navCtrl, router, alertCtrl) {
          var _this = this;

          _classCallCheck(this, IndividualPage);
        ...
        _createClass(IndividualPage, [{
          ...
          key: "profile",
          value: function profile($event, d) {
            var _this2 = this;
            ...
            if (d == 'Profilephoto') {
              this.m = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            } else if (d == 'About_Mephoto') {
              this.m1 = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            } else if (d == 'childhood_and_Educationphoto') {
              this.cm = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            } else if (d == 'Political_Careerphoto') {
              this.pol = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            } else if (d == 'Personal_Lifephoto') {
              this.per = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            } else if (d == 'aims_Goal_and_Dreamphoto') {
              this.aim = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            } else if (d == 'Message_For_Followersphoto') {
              this.msg = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Observable"](function (subscriber) {
                _this2.readFile(file, subscriber);
              });
            }
          }
          ...
          key: "readFile",
          value: function readFile(file, subscriber) {
            var _this3 = this;
            ...
            filereader.onload = function () {
              ...
              var url = _this3.mf + u + _this3.details['id'] + "/";

              _this3.user.individual1(filereader.result, url).subscribe(function (res) {
          ...
          key: "data",
          value: function data(c) {
            localStorage.setItem('ind', c);
            var u = localStorage.getItem('n');
            var url = this.mf + u + this.details['id'] + "/";
            this.user.individual1(this.details[c], url).subscribe(function (res) {});
            alert('saved');
          }
        }, {
          key: "ngOnInit",
      ...
      IndividualPage.ctorParameters = function () {
        return [{
      ...
      IndividualPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function TdKw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function v5aH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=default~individuallogin-individual-individual-module~individuallogin-rajyasabhaindividual-rajyasabha~d4f5ae7c-es5.js.map