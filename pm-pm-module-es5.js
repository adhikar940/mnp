(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pm-pm-module"], {
    ...
    /***/
    function MuQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function QwO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JpZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PmPage", function () {
        return PmPage;
      });
      /* harmony import */
      ...
      var _raw_loader_pm_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./pm.page.html */
      "4QwO");
      /* harmony import */


      var _pm_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./pm.page.scss */
      "1MuQ");
      /* harmony import */
      ...
      var PmPage = /*#__PURE__*/function () {
        function PmPage(user, router) {
          var _this = this;
          ...
          this.mk = [];
          this.selected = null;
          this.user.pm().subscribe(function (data) {
            console.warn(data);
            _this.k = data;
          });
          this.user.mankibath().subscribe(function (res) {
            console.log(res);
            _this.mk = res;
          });
      ...
      PmPage.ctorParameters = function () {
        return [{
      ...
      PmPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-pm',
    ...
    /***/
    function afUH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PmPageRoutingModule", function () {
        return PmPageRoutingModule;
      });
      /* harmony import */
      ...
      var _pm_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./pm.page */
      "Jp+Z");
      ...
      var PmPageRoutingModule = function PmPageRoutingModule() {
        _classCallCheck(this, PmPageRoutingModule);
      };

      PmPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function iBhr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PmPageModule", function () {
        return PmPageModule;
      });
      /* harmony import */
      ...
      var _pm_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./pm-routing.module */
      "afUH");
      /* harmony import */


      var _pm_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./pm.page */
      "Jp+Z");

      var PmPageModule = function PmPageModule() {
        _classCallCheck(this, PmPageModule);
      };

      PmPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _pm_routing_module__WEBPACK_IMPORTED_MODULE_5__["PmPageRoutingModule"]],
...
//# sourceMappingURL=pm-pm-module-es5.js.map